...
export const CONTENT: ContentConfig = {
  systems: [
    ...
    {
      id: "railwaywiki",
      dir: "content/railwaywiki",
      defaultDocRedirect: "/railwaywiki/index",
      route: '/railwaywiki',
    },
   // {
   //   id: "builderswiki",
   //   dir: "content/builderswiki",
   //   defaultDocRedirect: "/builderswiki/index",
   //   route: 'content/builderswiki',
   // }
  ],
}
...
export const SITE: SiteConfig = {
  ...
  title: 'GNU/Genshin Metro Project',
  description:
...
export const HEADER_NAV_ITEMS: NavItem[] = [
  ...
  { href: '/builders', label: 'Builders Wiki' },
  { href: '/railwaywiki', label: 'Railway Wiki' },
  { href: '/stations', label: 'Station Wiki' },
  { href: 'https://www.planetminecraft.com/project/1-19-2-the-gnu-genshin-subway-project/', label: 'Download' },
]
